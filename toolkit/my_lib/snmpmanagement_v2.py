...
class CommonSettingsAllProtocols:
    snmp_get = path_snmpget
    snmp_set = path_snmpset
...
############ Классы ################
class Swarco(CommonSettingsAllProtocols):
    community = 'private'
...
class PotokS(CommonSettingsAllProtocols):
    ...
    **********************************************************************
    ...
    def get_stage_stcip_potok(self):
        """  Возвращает номер текущей фазы """
        ...
        oid = self.oids_STCIP_POTOK.get(self.get_current_stage_potok_STCIP)
        bad_oid = ['\n']
    ...
    def get_status_stcip_potok(self):
        """Возвращает статусы работы ДК: (INTEGER):
    ...
    def get_dark_stcip_potok(self):

        oid = self.oids_STCIP_POTOK.get(self.dark_potok_STCIP)
        bad_oid = ['\n']
    ...
    def get_flash_stcip_potok(self):
        """ Возвращает значение (INTEGER):
            0 - ЖМ выключить
            2 - ЖМ включить
        """

        oid = self.oids_STCIP_POTOK.get(self.yellow_flash_potok_STCIP)
        bad_oid = ['\n']
    ...
    def get_all_red_stcip_potok(self):
        """ Возвращает значение (INTEGER):
            0 - КК выключить
            2 - КК включить
        """

        oid = self.oids_STCIP_POTOK.get(self.all_red_potok_STCIP)
        bad_oid = ['\n']
    ...
    **********************************************************************
    ...
    def set_reset_dark_stcip_potok(self, value='0'):
    ...
    def set_reset_yellow_flash_stcip_potok(self, value='0'):
    ...
    def set_reset_all_red_stcip_potok(self, value='0'):
    ...
    def set_stage_stcip_potok(self, value='ЛОКАЛ'):
        ...
        oid = f'{self.oids_STCIP_POTOK.get(self.set_stage_potok_STCIP)}'
    ...
    def restart_programm_stcip_potok(self, value='1'):
        """ Функция перезапускает программу ДК..
            Необходимо передать ip, scn в виде "COxxxx"(например "СO1111".
        """

        oid = f'{self.oids_STCIP_POTOK.get(self.set_restart_programm_potok_STCIP)}'
...
def get_stage_stcip_potok(ip_adress: str):
    ...
    print(f'ip_adress из функции: {ip_adress}')
    print(f'community из функции: {community}')
